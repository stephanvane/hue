...
(function() {
  $(function() {
    return $('.find-light-link').click(function(e) {
      var alertData, id, req1, req2;
      e.preventDefault();
      id = $(this).data('id');
      alertData = {
        bri: 255,
      ...
      return $.when(req1, req2).done(function(res1, res2) {
        var old_state;
        old_state = {
        ...
        return setTimeout(function() {
          return $.ajax("" + gon.endpoint + "/lights/" + id + "/state", {
  ...
  $(function() {
    return $('.picker').ColorPicker({
      ...
      onSubmit: function(hsb) {
        ...
        return $.each($('#timer_light_ids').val(), function(_, id) {
          var req1, req2;
          req1 = $.get("" + gon.endpoint + "/lights/" + id);
          req2 = $.ajax("" + gon.endpoint + "/lights/" + id + "/state", {
